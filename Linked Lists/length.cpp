...
int lengthOfLinkedList(Node* head) //function to calculate the length of the linked list
{
...
int main() //main function, where the execution of the program begins
{
    ...
    cout<<"length: "<<lengthOfLinkedList(head); //print the length of the linked list
